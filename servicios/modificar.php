        ...
        if ($editar=$result-> fetch(PDO::FETCH_ASSOC)){
            ...
            <div id="res">
                ...
                <form action="upd.php" method="POST">
                    <label id="lab1">N. de servicio:</label>
                    <div>
                    ...
                    <div>
                    <input type="text" id="inp2" name="nombre" value="<?php echo $editar['nombre_servicio'] ?>">
                    </div>

                    <label id="lab4">Apellido:</label>
                    <div>
                    <input type="text" id="inp4" name="usua" value="<?php echo $editar['precio_servicio'] ?>">
                    </div>
