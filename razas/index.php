...
<nav class="navbar navbar-dark bg-dark">
  <div class="container-fluid">
    ...
    <form method="post" action="buscar.php">
        ...
        ?>
        <tr>
            <td><?php echo $move->id_raza;?></td>
            <td><?php echo $move->nombre_raza?></td>
            <td>
                    <a class="btn btn-primary" href="eliminar.php?id=<?php echo $move->id_raza?> & nomb=<?php echo $move->nombre_raza?>">
					    eliminar
                    </a>
                </td>
                <td>
                    <a class="btn btn-primary" href="modificar.php?id=<?php echo $move->id_raza?> & nomb=<?php echo $move->nombre_raza?>">
					    editar
                    </a>
                </td>
            </tr>
