<?php
   ...
   $tip=                   $_SESSION['tip'];
    ...
    $sentencia1="SELECT * FROM auxiliar";
...
<nav class="navbar navbar-dark bg-dark">
  <div class="container-fluid">
    ...
    <form method="post" action="buscar.php">
        ...
        <button  class="btn btn-primary"  class="uno">buscar</button>
        <br> <br>
        <div id="tag">
        <table  class="table">
        <tr>
        ...
        ?>
        <tr>
            <td><?php echo $move->id_auxiliar;?></td>
            <td><?php echo $move->nombre_auxiliar?></td>
            <td><?php echo $move->apellido_auxiliar?></td>
            <td>
                    <a  class="btn btn-primary" href="eliminar.php?id=<?php echo $move->id_auxiliar?> & nomb=<?php echo $move->nombre_auxiliar?>">
					    eliminar
                    </a>
                </td>
                <td>
                    <a  class="btn btn-primary" href="modificar.php?id=<?php echo $move->id_auxiliar?> & nomb=<?php echo $move->nombre_auxiliar?>">
					    editar
                    </a>
                </td>
            </tr>
