    ...
    <div id="res">
        <div id="h2"><h2 id="h2_1">Informacion</h2></div>
            <form action="./index.php" method="POST">
                ...
                <div>
                    <input type=»text» id="inp2" readonly=»readonly» name="id" placeholder="<?php echo $tipo?>"/>
                </div>

                <label id="lab4">Apellido:</label>
                <div>
                    <input type=»text» id="inp4" readonly=»readonly» name="id" placeholder="<?php echo $nombre?>"/>
                </div>
