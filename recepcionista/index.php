<?php
   ...
   $tip=                   $_SESSION['tip'];
    ...
    $sentencia1="SELECT * FROM recepcionista";
...
<nav class="navbar navbar-dark bg-dark">
  <div class="container-fluid">
    ...
    <form method="post" action="buscar.php">
        ...
        ?>
        <tr>
            <td><?php echo $move->id_recepcionista;?></td>
            <td><?php echo $move->nombre_recepcionista?></td>
            <td><?php echo $move->apellido_recepcionista?></td>
            <td>
                    <a class="btn btn-primary" href="eliminar.php?id=<?php echo $move->id_recepcionista?> & nomb=<?php echo $move->nombre_recepcionista?>">
					    elimimar
                    </a>
                </td>
                <td>
                    <a class="btn btn-primary"  href="modificar.php?id=<?php echo $move->id_recepcionista?> & nomb=<?php echo $move->nombre_recepcionista?>">
					    editar
                    </a>
                </td>
            </tr>
