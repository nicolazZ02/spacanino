...
require("../conexion/conexion.php");
    ...
    try {
        $sql="SELECT * FROM recepcionista WHERE id_recepcionista= :co";
        ...
        if ($editar=$result-> fetch(PDO::FETCH_ASSOC)){
            ...
            <div id="res">
                ...
                <form action="upd.php" method="POST">
                    ...
                    <div>
                    <input type="text" id="inp2" name="nombre" value="<?php echo $editar['nombre_recepcionista'] ?>">
                    </div>

                    <label id="lab4">Apellido:</label>
                    <div>
                    <input type="text" id="inp4" name="usua" value="<?php echo $editar['apellido_recepcionista'] ?>">
                    </div>
